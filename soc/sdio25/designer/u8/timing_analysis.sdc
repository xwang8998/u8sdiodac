...
create_clock -name {sdm_clk} -period 16 -waveform {0 8 } [ get_pins { test_0/u100/USDMCLK/Y } ]
create_clock -name {dac_clock} -period 16 -waveform {0 8 } [ get_pins { *DACCLK*/Y } ]
...
set_output_delay 3.5 -clock {dem_clk} [ get_ports { *dsd_* } ]
